...
show_quick_start() {
    ...
    echo -e "   ${CYAN}make install-dev${NC}        # Full development environment"
    echo -e ""
...
show_install_help() {
    ...
    echo -e "  ${CYAN}install-dev${NC}             Full development environment"
...
show_workflows_help() {
    ...
    echo -e "  ${CYAN}make setup && make install-dev && make test${NC}"
    echo -e ""
...
show_examples_help() {
    ...
    echo -e "  ${CYAN}make install-dev${NC}        # Install all dependencies"

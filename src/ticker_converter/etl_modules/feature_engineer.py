...
class FeatureEngineer:
    ...
    def engineer_features(self, cleaned_data: CleanedMarketData) -> FeatureEngineeredData:
    ...
    def _calculate_volatility_metrics(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        try:
            ...
            df['Volatility'] = df['Daily_Return'].rolling(window=window, min_periods=1).std()
    ...
    def _calculate_price_features(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        try:
            ...
            if 'Volume' in df.columns:
                ...
                self.features_created.extend(['Volume_MA_20', 'Volume_Ratio', 'High_Volume'])

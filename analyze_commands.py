...
class MakefileAnalyzer:
    ...
    def analyze_implementation_overlap(self):
        ...
        if overlap_groups:
            ...
            for group in overlap_groups:
                ...
                for cmd in group:
                    impl_preview = (
                        implementations[cmd][:100] + "..." if len(implementations[cmd]) > 100 else implementations[cmd]
                    )
    ...
    def generate_optimization_report(self):
        ...
        print(
            f"- **Alias Ratio**: {((stats['direct_aliases'] + stats['legacy_aliases']) / stats['total_commands'] * 100):.1f}%"
        )
        print()

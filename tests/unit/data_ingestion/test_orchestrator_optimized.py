...
class TestDataIngestionOrchestratorOptimized:
    ...
    def test_perform_initial_setup_success_scenarios(
        ...
        assert_result_structure(
            result, ["operation", "success", "total_records_inserted", "errors", "start_time", "end_time"]
        )
    ...
    def test_perform_initial_setup_api_errors(
        self, orchestrator_with_mocks, mock_api_errors
    ...
    def test_perform_initial_setup_database_errors(
        self, orchestrator_with_mocks, mock_database_errors
    ) -> None:  # pylint: disable=unused-argument
    ...
    def test_run_full_ingestion_empty_database(
        self, orchestrator_with_mocks, mock_empty_database
    ) -> None:  # pylint: disable=unused-argument
        ...
        test_currency_data = [
            TestDataBuilder().with_date("2025-08-17").with_exchange_rate(0.7850).with_currencies("USD", "GBP").build()
        ]

...
@pytest.fixture
def orchestrator_with_mocks(mock_components: MockDataIngestionComponents) -> tuple[DataIngestionOrchestrator, MockDataIngestionComponents]:
...
@pytest.fixture
def mock_successful_setup(mock_components: MockDataIngestionComponents, sample_stock_data: list[dict[str, Any]], sample_currency_data: list[dict[str, Any]]) -> MockDataIngestionComponents:

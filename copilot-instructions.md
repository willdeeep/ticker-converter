...
*   **Refactoring Guidelines**: Follow the refactoring best practices outlined in [`python-refactoring.md`](my_docs/python-refactoring.md) when making code improvements or simplifications.
